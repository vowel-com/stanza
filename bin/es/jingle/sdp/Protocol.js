...
export function convertIntermediateToApplication(media, role) {
...
export function convertIntermediateToCandidate(candidate) {
    let component;
...
export function convertIntermediateToTransport(media, transportType) {
...
export function convertIntermediateToRequest(session, role, transportType) {
    return {
...
export function convertContentToIntermediate(content, role) {
...
export function convertRequestToIntermediate(jingle, role) {
    const session = {
        groups: [],
        media: []
    };
